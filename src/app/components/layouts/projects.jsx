            ...
            <div className="card-group">
                ...
                >
                    <p>
                        ...
                        &quot;Мой блог&quot;. Присутствует регистрация/вход
                        пользователя, возможность добавлять, удалять и
                        редактировать статьи. Все данные хранятся в базе данных
                        MongoDB.
                    </p>
                    <p>
                        P.S. Проект в стадии разработки! В планах: реализовать
                        адаптив, добавить редактор текста, реализовать
                        добавление картинок и видео.
                    </p>
                    <p>
                ...
                >
                    <p>
                        Сервис по поиску новостей. Реализован поиск статей по
                        ключевому слову за последние 7 дней. Максимальное число
                        статей - 100. Реализована кнопка &quot;показать
                        еще&quot;, которая добавляет по 3 новости. Есть страница
                        статистики, на которой показано количество статей по
                        ключевому слову за каждый день за последнюю неделю. На
                        странице &quot;О проекте&quot; есть блок с коммитами в
                        репозитории, где лежит данный проект. Слайдер реализован
                        с помощью библиотеки Swiper. Для коммитов использован
                        Github rest api. Также сделан адаптив под разные размеры
                        экранов, применен БЭМ.
                    </p>
